---
layout: post
title: Twitter AI精选 - 2026-05-05
date: 2026-05-05 09:11:30 +0800
category: twitter
---
...
---
**重要说明：** 由于 Twitter/X 需要登录才能访问，且无法从 Hugging Face Papers 等外部源获取真实 Twitter handle，今日推荐基于 Hugging Face Papers 页面真实提取的 AI 研究人员信息。以下 handle 为 Hugging Face/GitHub 用户名，非 Twitter handle。
---
...
所有精选内容来自 Hugging Face Papers 实时数据源：
- UniVidX: 多模态视频生成框架（SIGGRAPH 2026）
- Web2BigTable: Multi-Agent 搜索系统
- Prox-E: 3D 形状编辑
- Agent Skills: Agent 技能表示研究
- Stable-GFlowNet: LLM 红队测试
- Learning while Deploying: 机器人强化学习

**数据来源：** https://huggingface.co/papers （实时访问）
...
**备注：**
1. 今日推荐基于从 Hugging Face Papers 实时提取的真实数据（https://huggingface.co/papers）
